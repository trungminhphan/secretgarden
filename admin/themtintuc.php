            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <input class="form-control" type="text" id="tieude" name="tieude" placeholder="Tên danh mục tin tức" data-parsley-required="true" value="<?php echo isset($tieude) ? $tieude : ''; ?>" />
                    </div>
                </div>
                <div class="form-group">
...
<script>
    $(document).ready(function() {
        ...
        $("#language").change(function(){
            $.get("get.danhmuctintuc.html?act=show_select&language="+$(this).val(),function(data){
                $("#id_danhmuctintuc").html(data)
            });
        })
